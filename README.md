...
•	Student Name: Chris Kist, Shayla M, Colby
...
3.	Problem Statement
•	Right now, there is no alert system set up for the Discord server that is easy to monitor, need to add an alert mechanism to Grafana. 
